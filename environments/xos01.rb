...
debian_pkg_repository = "http://10.30.0.1:9090"

override_attributes(
  # "ceph" => {
  #   "debian" => {
  #     "repository" => "http://ceph.com/debian-emperor/",
  #     "repository_key" => "https://ceph.com/git/?p=ceph.git;a=blob_plain;f=keys/release.asc"
  #   },
  #   "branch" => "emperor",
  #   "config" => {
  #     "fsid" => "cf376172-55ef-410b-a1ad-b84d9445aaf1",
  #     "mon_initial_members" => "node12",
  #     "global" => {
  #       "public network" => "10.30.1.0/24"
  #     }
  #   }
  # },
  "postgresql" => {
